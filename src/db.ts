...
const quotes: IQuote[] = [
  ...
  },
  {
    id: 5,
    ru_lang: {
      title: 'Вас никогда не постигнет неудача, пока вы не перестанете стараться.',
      author: 'Альберт Эйнштейн',
    },
    en_lang: {
  ...
  },
  {
    id: 6,
    ru_lang: {
      title: 'Ваше время ограничено, так что не теряйте его, проживая чужую жизнь.',
      author: 'Стив Джобс',
    },
    en_lang: {
  ...
  },
  {
    id: 7,
    ru_lang: {
      title: 'Выживает не самый сильный и не самый умный, а тот, кто лучше всех приспосабливается к изменениям.',
      author: 'Чарльз Дарвин',
    },
    en_lang: {
      title: 'It is not the strongest of the species that survives, nor the most intelligent, but the one most responsive to change.',
  ...
  },
  {
    id: 9,
    ru_lang: {
      title: 'Жизнь это 10% того, что с нами происходит, и 90% того, как мы на это реагируем.',
  ...
  },
  {
    id: 10,
    ru_lang: {
      title: 'Нельзя быть слишком хорошо одетым или слишком хорошо образованным.',
      author: 'Оскар Уайльд',
    },
    en_lang: {
  ...
  },
    {
        id: 11,
        ru_lang: {
            title: 'Успех — это способность идти от одной неудачи к другой без потери энтузиазма.',
            author: 'Уинстон Черчилль',
        },
        en_lang: {
            title: 'Success is the ability to go from one failure to another with no loss of enthusiasm.',
    ...
    },
    {
        id: 13,
        ru_lang: {
            title: 'Человек, который не читает, не имеет преимуществ над человеком, который не умеет читать.',
            author: 'Марк Твен',
        },
        en_lang: {
            title: 'The man who does not read has no advantage over the man who cannot read.',
            author: 'Mark Twain',
        },
    },
    {
        id: 14,
        ru_lang: {
            title: 'Хорошие друзья, хорошие книги и спящая совесть вот это идеальная жизнь.',
            author: 'Марк Твен',
        },
        en_lang: {
    ...
    },
    {
        id: 21,
        ru_lang: {
            title: 'Люди, которые достаточно сумасшедшие, чтобы думать, что они могут изменить мир, — это те, кто это делают.',
            author: 'Стив Джобс',
        },
        en_lang: {
    ...
    },
    {
        id: 23,
        ru_lang: {
            title: 'Имейте отвагу следовать своему сердцу и интуиции. Они каким-то образом знают что кем вы по-настоящему хотите стать.',
            author: 'Стив Джобс',
        },
        en_lang: {
    ...
    },
    {
        ...
        en_lang: {
            title: 'Sometimes life is going to hit you in the head with a brick. Don’t lose faith.',
            author: 'Steve Jobs',
        },
    },
    {
        id: 25,
        ru_lang: {
            title: 'Ваше время ограничено, поэтому не тратьте его проживая чужую жизнь.',
            author: 'Стив Джобс',
        },
        en_lang: {
            title: 'Your time is limited, so don’t waste it living someone else’s life.',
    ...
    },
    {
        id: 28,
        ru_lang: {
            title: 'Иногда люди не хотят слышать правду, потому что они не хотят разрушить их иллюзии.',
            author: 'Фридрих Ницше',
        },
        en_lang: {
            title: 'Sometimes people don’t want to hear the truth because they don’t want their illusions destroyed.',
            author: 'Friedrich Nietzsche',
        },
    },
    {
    ...
    },
    {
        id: 30,
        ru_lang: {
            title: 'Когда мы утомлены, нас атакуют идеи, которые мы победили много лет назад.',
            author: 'Фридрих Ницше',
        },
        en_lang: {
            title: 'When we are tired, we are attacked by ideas we conquered long ago.',
            author: 'Friedrich Nietzsche',
        },
    },
    {
        id: 31,
        ru_lang: {
            title: 'Змея, которая не может сбросить кожу, умирает. Также и наш ум, который противится менять точку зрения; он перестает быть умом.',
            author: 'Фридрих Ницше',
        },
        en_lang: {
            title: 'The snake which cannot cast its skin has to die. As well the minds which are prevented from changing their opinions; they cease to be mind.',
            author: 'Friedrich Nietzsche',
        },
    },
    {
    ...
    },
    {
        id: 34,
        ru_lang: {
            title: 'Я ненавидел каждую минуту тренировок, но я говорил, «Не бросай. Страдай сейчас и живи оставшуюся жизнь как чемпион».',
            author: 'Мухаммед Али',
        },
        en_lang: {
            title: 'I hated every minute of training, but I said, ‘Don’t quit. Suffer now and live the rest of your life as a champion’.',
            author: 'Muhammad Ali',
        },
    },
    {
    ...
    },
    {
        id: 36,
        ru_lang: {
            title: 'Любовь состоит не в том, чтобы смотреть друг на друга, а в том, чтобы смотреть вместе в одном направлении.',
            author: 'Антуан де Сент-Экзюпери',
        },
        en_lang: {
            title: 'Love does not consist of gazing at each other, but in looking outward together in the same direction.',
    ...
    },
    {
        id: 37,
        ru_lang: {
            title: ' Все взрослые были однажды детьми… но лишь немногие из них помнят это.',
            author: 'Антуан де Сент-Экзюпери',
        },
        en_lang: {
    ...
    },
    {
        id: 39,
        ru_lang: {
            title: 'Я должен выдержать присутствие нескольких гусениц, если я хочу познакомиться к бабочками.',
            author: 'Антуан де Сент-Экзюпери',
        },
        en_lang: {
    ...
    },
    {
        id: 45,
        ru_lang: {
            title: 'Никогда не смейтесь над человеком, который говорит на ломаном английском. Это значит, что он знает и другой язык.',
            author: 'Х. Джексон Браун — младший',
        },
        en_lang: {
            title: 'Never make fun of someone who speaks broken English. It means they know another language.',
    ...
    },
    {
        id: 46,
        ru_lang: {
            title: 'Две вещи бесконечны — Вселенная и человеческая глупость, но насчёт Вселенной я не уверен.',
            author: 'Альберт Эйнштейн',
        },
        en_lang: {
            title: 'Only two things are infinite — the universe and human stupidity, and I’m not sure about the former.',
            author: 'Albert Einstein',
        },
    },
    {
        id: 47,
        ru_lang: {
            title: 'Больше не гоняясь за бабочками, мы с Камилой посадили наш сад, чтобы они могли прилетать к нам.',
            author: 'Мэттью Макконахи',
        },
        en_lang: {
            title: 'No longer chasing butterflies, Camila and I planted our garden so they could come to us.',
    ...
    },
    {
        id: 51,
        ru_lang: {
            title: 'Успех — это один процент вдохновения и девяносто девять процентов пота.',
            author: 'Томас Эдисон',
        },
        en_lang: {
            title: 'Success is one percent inspiration, ninety-nine percent perspiration.',
    ...
    },
    {
        id: 52,
        ru_lang: {
            title: 'Вы промахнётесь 100 раз из 100 бросков, которые так и не сделаете.',
            author: 'Уэйн Гретцки',
        },
        en_lang: {
    ...
    },
    {
        id: 53,
        ru_lang: {
            title: 'Вчера я был умным, поэтому я хотел изменить мир. Сегодня я мудр, поэтому меняюсь.',
            author: 'Руми',
        },
        en_lang: {
            title: 'Yesterday I was clever, so I wanted to change the world. Today I am wise, so I am changing myself.',
            author: 'Rumi',
        },
    },
    {
        id: 54,
        ru_lang: {
            title: 'Вы живете только один раз, но если вы все делаете правильно, достаточно одного раза',
            author: 'Мэй Уэст',
        },
        en_lang: {
    ...
    },
    {
        id: 55,
        ru_lang: {
            title: 'Вещи меняются. И друзья уходят. Жизнь ни для кого не останавливается.',
    ...
    },
    {
        id: 57,
        ru_lang: {
            title: '«Если у вас нет контроля над своим ртом, вы не сможете контролировать свое будущее.',
            author: 'Германия Кент',
        },
        en_lang: {
            title: 'If you do not have control over your mouth, you will not have control over your future.',
            author: 'Germany Kent',
        },
    },
    {
        id: 58,
        ru_lang: {
            title: 'Есть два вида идеальных людей: те, кто уже умерли, и те, кто еще не родились.',
            author: 'Китайская пословица',
        },
        en_lang: {
            title: 'There are two kinds of perfect people: those who are dead, and those who have not been born yet.',
    ...
    },
    {
        id: 59,
        ru_lang: {
            title: 'Мудрые люди говорят потому, что им есть, что сказать, глупцы — потому что они должны сказать что-то.',
            author: 'Платон',
        },
        en_lang: {
    ...
    },
    {
        id: 60,
        ru_lang: {
            title: 'Работайте усердно, чтобы получить то, что любите, иначе придется полюбить то, что получили.',
            author: 'Бернард Шоу',
        },
        en_lang: {
            title: 'Work hard to get what you like, otherwise you’ll be forced to just like what you get.',
            author: 'Bernard Shaw',
        },
    },
    {
        id: 61,
        ru_lang: {
            title: 'В конце концов, мы будем помнить не слова врагов, а молчание друзей.',
    ...
    },
    {
        id: 65,
        ru_lang: {
            title: 'Если слишком долго вглядываться в бездну, бездна начинает вглядываться в тебя.',
            author: 'Фридрих Ницше',
        },
        en_lang: {
            title: 'And if you gaze long into an abyss, the abyss also gazes into you.',
            author: 'Friedrich Nietzsche',
        },
    },
    {
    ...
    },
    {
        id: 67,
        ru_lang: {
            title: 'Женись несмотря ни на что. Если попадётся хорошая жена — будешь счастливым, если плохая — философом.',
            author: 'Сократ',
        },
        en_lang: {
            title: 'By all means marry; if you get a good wife, you’ll be happy. If you get a bad one, you’ll become a philosopher.',
            author: 'Socrates',
        },
    },
    {
    ...
    },
    {
        id: 78,
        ru_lang: {
            title: 'Зеркало — это мой лучший друг, потому что когда я плачу, оно никогда не смеется.',
